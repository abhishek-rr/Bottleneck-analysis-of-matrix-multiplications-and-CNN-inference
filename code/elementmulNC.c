...
void initiaze_matrices(double** a, double** b, double** c, int P, int N)
{
  int i,j;
...
void matmul(double** a, double** b, double** c, int P, int N)
{
  int i,j;
